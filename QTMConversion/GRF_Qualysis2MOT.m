...
% mot_filename = 'Active_Pref_100_0008';
% mot_filename = 'Active_Pref_100_0009';
% mot_filename = 'Active_Pref_100_0011';
% mot_filename = 'Active_Pref_100_0018';
% mot_filename = 'Active_Pref_100_0019';
% mot_filename = 'Active_Pref_100_0020';
% mot_filename = 'Active_Pref_100_0021';
% mot_filename = 'Active_Pref_100_0025';
mot_filename = 'Active_Pref_100_0027';

f_cut = 5; % cut off force at 5N

%% The starting and ending time heel strike and toe off on each plate (Can read-in from file):

% A07, Active Pref Trial 0008.
% plate_cut_t = [.664, 4;       % plate 1 heel strike and toe off
%                0.003, .802;    % plate 2 heel strike and toe off
%                0, .145;    % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0009.
% plate_cut_t = [.659, 4;       % plate 1 heel strike and toe off
%                0.003, .778;    % plate 2 heel strike and toe off
%                0, .153;         % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0011.
% plate_cut_t = [.667, 4;       % plate 1 heel strike and toe off
%                0.003, .802;    % plate 2 heel strike and toe off
%                0, .16;         % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0018.
% plate_cut_t = [.672, 4;       % plate 1 heel strike and toe off
%                0.003, .8;    % plate 2 heel strike and toe off
%                0, .155;         % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0019.
% plate_cut_t = [.672, 4;       % plate 1 heel strike and toe off
%                0.003, .811;    % plate 2 heel strike and toe off
%                0, .155;         % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0020.
% plate_cut_t = [.672, 4;       % plate 1 heel strike and toe off
%                0.003, .811;    % plate 2 heel strike and toe off
%                0, .155;         % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0021.
% plate_cut_t = [.69, 4;       % plate 1 heel strike and toe off
%                0.003, .824;    % plate 2 heel strike and toe off
%                0, .15;         % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0025.
% plate_cut_t = [.655, 4;       % plate 1 heel strike and toe off
%                0.003, .79;    % plate 2 heel strike and toe off
%                0, .149;         % plate 3 heel strike and toe off
%                4, 4;           % plate 4 heel strike and toe off
%                4, 4];          % plate 5 heel strike and toe off
% A07, Active Pref Trial 0027.
plate_cut_t = [.642, 4;       % plate 1 heel strike and toe off
               0.003, .785;    % plate 2 heel strike and toe off
               0, .149;         % plate 3 heel strike and toe off
               4, 4;           % plate 4 heel strike and toe off
               4, 4];          % plate 5 heel strike and toe off
