...
% Modified by: Andrew LaPre to use as a function.
...
Left_plate = options.leftPlate; %plate 2 belong to left leg

% MOT file output filename:
mot_filename = options.newName;
